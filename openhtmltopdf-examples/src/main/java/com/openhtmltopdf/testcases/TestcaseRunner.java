...
public class TestcaseRunner {
    ...
    private static void renderPNG(String html, final String filename) throws Exception {
        ...
        if (SystemUtils.IS_JAVA_1_6) {
            builder.useDocumentBuilderFactoryImplementationClass("org.apache.xerces.jaxp.DocumentBuilderFactoryImpl");
            builder.useTransformerFactoryImplementationClass("org.apache.xalan.xsltc.trax.SmartTransformerFactoryImpl");
        }
        builder.useSVGDrawer(new BatikSVGDrawer());
        builder.useMathMLDrawer(new MathMLDrawer());
        builder.addDOMMutator(LaTeXDOMMutator.INSTANCE);
